...
public fun escape4cli(s: Any): String = escape4cli(s.toString())

public fun runProcess(command: Iterable<String>, listenStdout: (String) -> Unit = {}, listenStderr: (String) -> Unit = {}): Int {
